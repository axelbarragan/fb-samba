...
<head>
  ...
  <title><?php echo NOMBRE_PROYECTO." | ".ADMIN; ?></title>
...
<div class="wrapper">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="hoteles/agregar"><i class="fa fa-plus"></i> Agregar</a></li>
            <li><a href="hoteles/enlistar"><i class="fa fa-circle-o"></i> Ver lista</a></li>
          </ul>
        </li>
  ...
  <footer class="main-footer">
    ...
    <strong>Desarrollado por Flubox &copy; 2017 <a href="http://www.flubox.com.mx">Flubox</a>.</strong> 
  </footer>
